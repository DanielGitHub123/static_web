...
(function ($) {
    ...
    $.extend(DateTime.prototype, {
        initPicker: function(options, defaults) {
            ...
            //store DPglobal
            // console.dir($.fn.datetimepicker.Constructor);
            //this.dpg = $.fn.datetimepicker.DPGlobal; 
            //store parsed formats
            //this.parsedFormat = $.fn.datetimepicker.parseFormat(this.options.format, this.options.formatType);
       ...
       */
       parseDate: function(str, format) {
           var date = null, formattedBack;
           if(str) {
               date = new Date(str); //this.dpg.parseDate(str, format, this.options.datetimepicker.language, this.options.formatType);
               // if(typeof str === 'string') {
